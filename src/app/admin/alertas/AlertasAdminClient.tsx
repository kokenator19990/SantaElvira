  ...
  return (
    <div className="flex flex-col gap-5 max-w-[700px] mx-auto">
      ...
      <div className="p-4 rounded-[10px] bg-white border border-[#E4E4E7] flex flex-col gap-3">
        ...
        <ul className="text-[12px] text-[#71717A] list-disc pl-5 space-y-1">
          <li>Cargar KPIs nuevos (auto se regenera al guardar, pero puedes forzarlo)</li>
          <li>Cambiar los umbrales en la tabla <code className="text-[10px] font-mono bg-[#F4F4F5] px-1 rounded">umbral_kpi</code></li>
          <li>Marcar/desmarcar paros</li>
        </ul>

        <div className="flex flex-wrap items-end gap-3 pt-2 border-t border-[#F4F4F5]">
          <label className="flex flex-col gap-1">
            <span className="text-[10px] font-bold text-[#71717A] uppercase">Período</span>
            <select
              value={periodoId}
          ...
          <button
            onClick={regenerar}
            disabled={pending}
            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-[7px] bg-[#09090B] hover:bg-[#27272A] disabled:opacity-50 text-white text-[12px] font-semibold"
          >
