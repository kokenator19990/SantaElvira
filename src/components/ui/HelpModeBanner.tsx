  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-[10000] flex items-center justify-between gap-3 px-4 py-2.5 bg-amber-500 shadow-lg">
      <div className="flex items-center gap-2">
        ...
        <span className="hidden sm:inline text-[12px] text-amber-100 font-normal">
          · Pasa el cursor sobre cualquier indicador o sección para ver su explicación detallada
        </span>
      </div>
      <div className="flex items-center gap-3">
        <kbd className="hidden sm:inline-flex items-center gap-1 px-2 py-0.5 rounded bg-amber-600/60 text-white text-[11px] font-mono border border-white/20">
          ESC
        </kbd>
        <span className="hidden sm:inline text-[11px] text-amber-100">para salir</span>
        <button
          onClick={deactivate}
